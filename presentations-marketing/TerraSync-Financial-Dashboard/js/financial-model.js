...
class TerrasyncFinancialModel {
    constructor() {
        ...
        this.revenue = {
            ...
            expansionRevenueFactor: 0.40    // 40% annual expansion revenue from service plan customers
        };
    ...
    calculateMonthlyRevenue(month) {
        ...
        // Expansion revenue from service plan customers (40% annually, distributed monthly)
        const expansionRevenue = serviceRevenue * (this.revenue.expansionRevenueFactor / 12);
        ...
        const totalRevenue = serviceRevenue + saasRevenue + additionalRevenue + 
                           productRevenue + installationRevenue + expansionRevenue;
        const recurringRevenue = serviceRevenue + saasRevenue + expansionRevenue;
    ...
    calculateGrossProfit(revenue) {
        ...
        const expansionGP = revenue.expansion * this.margins.service; // Assume same margin as service
        
        const totalGP = serviceGP + saasGP + additionalGP + productGP + installationGP + expansionGP;
    ...
    generateProjection(months = 60) {
        ...
        for (let month = 0; month < months; month++) {
            ...
            projection.push({
                ...
                expansionRevenue: Math.round(monthlyData.revenue.expansion),
